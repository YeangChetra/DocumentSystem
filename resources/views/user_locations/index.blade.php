<x-app-layout>
    <main>
        ...
        <div class="container-fluid">
            <h2 class="mt-30 page-title">User Locations</h2>
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="bulk-section mt-30">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="status-btn hover-btn" id="search" name="false" type="button">Search locations</button>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                                            <img style="width: 35px;border-radius: 50%;border: 1px #45bbe0 solid;" src="{{ $list?$list->profile_photo_url : '' }}" alt="{{ $list ? $list->name : '' }}">
                                                        @else
